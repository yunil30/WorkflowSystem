    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <label>Would you like to log out?</label>
            </div>
            <div class="modal-footer">
                <button type="button" id="BtnYesLogout">Yes</button>
                <button type="button" id="BtnNoLogout" data-dismiss="modal">No</button>
            </div>
        </div>
    </div>
</div>
