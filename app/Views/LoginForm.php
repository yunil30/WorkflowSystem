...
<script>
    ...
    $('#BtnLogInUser').click(function(event) {
        ...
        axios.post(host_url + 'Login/Authenticate', data).then(function(res) {
            Swal.fire({
                icon: 'success',
                title: 'Successful!',
                ...
                if (result.isConfirmed) {
                    setTimeout(() => {
                        var index = host_url + 'Home/ShowListOfUsers';
